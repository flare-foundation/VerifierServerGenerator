...
export const CONFIGS_PATH = `${GENERATED_PATH}/config`;
export const ABI_PATH = `${GENERATED_PATH}/abi`;
export const DTO_PATH = `${GENERATED_PATH}/dto`;
export const MD_DOCS_PATH = 'specs/attestations/active-types';
export const MD_INDEX_FILE = 'specs/attestations/active-types.md';
export const LIBS_PATH = 'libs/ts';
export const TS_TYPES_PATH = `${GENERATED_PATH}/types/typescript`;
