...
export interface IPaymentTemporaryInterface extends Interface {
  getFunction(
...
export interface IPaymentTemporary extends BaseContract {
  connect(runner?: ContractRunner | null): IPaymentTemporary;
  waitForDeployment(): Promise<this>;

  interface: IPaymentTemporaryInterface;
